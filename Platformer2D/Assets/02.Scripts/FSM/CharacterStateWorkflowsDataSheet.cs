...
public static class CharacterStateWorkflowsDataSheet
{
                ...
                default:
                    {
                        ...
                        {
                            next = machine.isGrounded ? State.Idle : State.Jump;
                        }
                    }
                    break;
            }
                ...
                default:
                    {
                        ...
                        {
                            next = (_startPosY - rigidbody.position.y) <  _landingDistance ? State.Idle : State.Jump;
                        }
                    }
                    break;
            }
    ...
    public class Crouch : WorkflowBase
    {
        ...
        private Vector2 _offestCrouched;
        private Vector2 _sizeCrouched;
        private Vector2 _offestOrigin;
        private Vector2 _sizeOrigin;

        public Crouch(CharacterMachine machine, Vector2 offestCrouched, Vector2 sizeCrouched) : base(machine)
        {
            _offestCrouched = offestCrouched;
            _sizeCrouched = sizeCrouched;
            _offestOrigin = colliders[0].offset;
        ...
        public override void OnEnter()
        {
            ...
            {
                colliders[i].offset = _offestCrouched;
        ...
        public override void OnExit()
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                colliders[i].offset = _offestOrigin;
